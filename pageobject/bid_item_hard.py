...
class BidItemHard(BasePage):
    ...
    # 点击新增按钮
    business_process_sy = (By.XPATH, "//div[@span='8']//button[4]")
    # 输入新增项目名称
    ...
    # 点击投标启动时间
    business_process_dw20 = (By.XPATH, "//input[@placeholder='请选择投标启动时间']")
    # 请选择投标启动时间：今天
    business_process_dw201 = (By.XPATH, "//div[@x-placement='top-end']//button[text()='今天']")
    # 点击回标时间
    business_process_dw22 = (By.XPATH, "//input[@placeholder='请选择回标时间']")
    # 请选择回标时间：今天
    ...
    # 选择一个合约负责人
    business_process_dw27 = (By.XPATH, "//input[@placeholder='选择一个合约负责人']")
    # 选择列表中第一个人员
    ...
    # 商务标占比
    business_process_dw32 = (By.XPATH, "//input[@placeholder='请输入商务标占比']")
    # 技术标占比
    business_process_dw34 = (By.XPATH, "//input[@placeholder='请输入技术标占比']")
    # 是否合作过
    business_process_dw35 = (By.XPATH, "//*[contains(text(),'是否合作过：')]//parent::div//input")
    # 选择是否合作过
    business_process_dw351 = (By.XPATH, "//div[@x-placement='top-start']//li")
    business_process_dw36 = (By.XPATH, "//div[@aria-label='提示']//span[text()='取消']")

    def test_bid_hard(self, username, password, value1, value2, value3, value4, value5, value6,
                      value7, value8, value9, value11):
        login = LoginPage(self.driver)  # 登录
        login.login_erp(username, password)  # 输入用户名、密码

        sleep(1)
        self.click(BidItemHard.business_process_dw36)
        sleep(1)
        logger.info('点击“商务流程”')
        self.click(BidItemHard.business_process)  # 点击“商务流程”
        logger.info('点击“项目立项”')
        self.click(BidItemHard.approve_project)  # 点击“项目立项”
        logger.info('点击“商务投标”')
        self.click(BidItemHard.commercial_bid)  # 点击“商务投标”
        logger.info('点击“商务投标硬装”')
        self.click(BidItemHard.bidding_project_hard)  # 点击“商务投标硬装”
        sleep(1)
        logger.info('点击“新增”')
        self.click(BidItemHard.business_process_sy)  # 点击“新增”
        logger.info('输入项目名称')
        self.send_ks(BidItemHard.business_process_dw, value1)  # 输入项目名称
        # logger.info('点击所属事业部')
        # self.click(BidItemHard.business_process_syb)  # 点击所属事业部
        # logger.info('点击选择硬装')
        # self.click(BidItemHard.business_process_syb1)  # 选择硬装
        logger.info('点击省/市')
        self.click(BidItemHard.business_process_dw1)  # 点击省/市
        logger.info('选择省/市')
        self.click_index(BidItemHard.business_process_dw2, 0)  # 选择省/市
        logger.info('点击区域')
        self.click(BidItemHard.business_process_dw3)  # 点击区域
        sleep(1)
        logger.info('选择区域')
        self.click_index(BidItemHard.business_process_dw4, 0)  # 选择区域
        logger.info('输入详细地址')
        self.send_ks(BidItemHard.business_process_dw5, value2)  # 输入详细地址
        logger.info('点击客户来源')
        self.click(BidItemHard.business_process_dw7)  # 点击客户来源
        sleep(1)
        logger.info('选择客户来源')
        self.click_index(BidItemHard.business_process_dw8, 0)  # 选择客户来源
        logger.info('点击公司软装')
        self.click(BidItemHard.business_process_dw9)  # 点击公司软装
        sleep(1)
        logger.info('选择是否公司软装')
        self.click_index(BidItemHard.business_process_dw10, 0)  # 选择是否公司软装
        logger.info('输入设计风格')
        self.send_ks(BidItemHard.business_process_dw11, value3)  # 输入设计风格
        logger.info('点击预计完成时间')
        self.click(BidItemHard.business_process_dw21)
        sleep(0.5)
        logger.info('选择预计完成时间')
        self.click(BidItemHard.business_process_dw211)
        logger.info('点击施工图时间')
        self.click(BidItemHard.business_process_dw23)
        sleep(1)
        logger.info('选择施工图时间')
        self.click(BidItemHard.business_process_dw231)
        logger.info('点击法人主体')
        self.click(BidItemHard.business_process_dw19)
        logger.info('选择法人主体')
        self.click(BidItemHard.business_process_dw191)
        logger.info('输入商务标占比')
        self.send_ks(BidItemHard.business_process_dw32, value8)
        logger.info('输入技术标占比')
        self.send_ks(BidItemHard.business_process_dw34, value9)
        logger.info('点击投标启动时间')
        self.click(BidItemHard.business_process_dw20)  # 点击投标启动时间
        logger.info('选择投标启动时间')
        self.click(BidItemHard.business_process_dw201)  # 选择投标启动时间
        logger.info('点击回标时间')
        self.click(BidItemHard.business_process_dw22)
        sleep(1)
        logger.info('选择回标时间')
        self.click(BidItemHard.business_process_dw221)
        logger.info('点击是否合作过')
        self.click(BidItemHard.business_process_dw35)  # 点击是否合作过
        logger.info('选择是否合作过')
        self.click_index(BidItemHard.business_process_dw351, 0)  # 选择是否合作过
        logger.info('填写合作记录')
        self.send_ks(BidItemHard.business_process_dw33, value5)  # 填写合作记录
        logger.info('点击商务总监')
        self.click(BidItemHard.business_process_dw25)
        logger.info('输入总监名字查找')
        self.send_ks(BidItemHard.business_process_dw251, value6)  # 输入查找总监姓名
        logger.info('点击“查找”按钮')
        self.click(BidItemHard.business_process_dw252)  # 点击查询按钮
        sleep(1)
        logger.info('选择搜索到的第一个人员')
        self.click(BidItemHard.business_process_dw253)  # 选择搜索到的第一个人员
        logger.info('点击确定按钮')
        self.click(BidItemHard.business_process_dw254)  # 点击确定按钮
        logger.info('点击商务经理')
        self.click(BidItemHard.business_process_dw26)  # 选择一个商务经理
        sleep(1)
        logger.info('选择列表中第一个人员')
        self.click(BidItemHard.business_process_dw261)  # 选择列表中第一个人员
        logger.info('点击确定按钮')
        self.click(BidItemHard.business_process_dw262)  # 点击确定按钮
        # logger.info('选择一个结算人员')
        # self.click(BidItemHard.business_process_dw27)  # 选择一个结算人员
        # sleep(1)
        # logger.info('选择列表中第一个人员')
        # self.click(BidItemHard.business_process_dw271)  # 选择列表中第一个人员
        # logger.info('点击确定按钮')
        # self.click(BidItemHard.business_process_dw272)  # 点击确定按钮
        logger.info('点击商务进度')
        self.click(BidItemHard.business_process_dw28)  # 点击商务进度
        sleep(1)
        logger.info('选择商务进度')
        self.click_index(BidItemHard.business_process_dw281, 1)  # 选择商务进度
        logger.info('点击是否补充协议')
        self.click(BidItemHard.business_process_dw29)  # 点击是否补充协议
        sleep(0.5)
        logger.info('选择是否补充协议')
        self.click_index(BidItemHard.business_process_dw291, 1)  # 选择是否补充协议
        logger.info('点击甲方信息')
        self.click(BidItemHard.business_process_dw30)  # 点击甲方信息
        logger.info('点击签约甲方')
        self.click(BidItemHard.business_process_dw301)  # 点击签约甲方
        logger.info('输入客户编号')
        self.send_ks(BidItemHard.business_process_dw303, value7)  # 输入客户编号
        logger.info('点击查询按钮')
        self.click(BidItemHard.business_process_dw304)  # 点击查询按钮
        sleep(1)
        logger.info('选择第一条')
        self.click(BidItemHard.business_process_dw305)  # 选择第一条
        logger.info('点击确定按钮')
        self.click(BidItemHard.business_process_dw306)  # 点击确定按钮
        logger.info('点击保存')
        self.click(BidItemHard.business_process_dw31)  # 点击保存

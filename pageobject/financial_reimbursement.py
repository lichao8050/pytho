...
'''
logger.info('---报销管理--报销申请---')


class ExpenseClaim(BasePage):
    """报销管理--报销申请"""
    # 提交审批
    expense_claim_submit_button = (By.XPATH, "//span[text()='地產事業部']")
    # 审批流程图
    expense_claim_flow_chart =
    # 清空
    expense_claim_clear_button
    # 报销人
    expense_claim_reimbursement_applicant
    # 发票抬头
    expense_claim_invoice_title
    # 部门名称
    expense_claim_industry_title
    # 报销类型
    expense_claim_type
    # 报销币种
    expense_claim_currency
    # 报销事由
    expense_claim_cause
    # 复制上行
    expense_claim_copy
    # 新建空行
    expense_claim_new_add
    # 删除
    expense_claim_delete
    # 项目代码/名称
    expense_claim_name
    # 所属事业部
    expense_claim_business_division
    # 费用日期
    expense_claim_date
    # 实际费用类型
    expense_claim_practical_type
    # 发票费用类型
    expense_claim_invoice_type
    # 税率
    expense_claim_tax_rate
    # 发票票号
    expense_claim_number
    # 报销金额
    expense_claim_money
    # 不含税金额
    expense_claim_no_tax_rate
    # 税金
    expense_claim_taxes
    # 备注
    expense_claim_remark
    # 暂存
    expense_claim_temporary_file


    expense_claim_ = (By.XPATH, "//*[text()='硬装配合项目']")
    # 点击清空按钮
    ...
    def test_expense_claim(self, username, password, value1, value2, value3, value4, value5, value6, value7,
